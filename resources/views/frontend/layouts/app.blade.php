            ...
            <div class="flex flex-col items-center justify-between gap-5 sm:flex-row">
                ...
                <div class="flex items-center gap-3">
                    <a
                        ...
                        class="flex h-11 w-11 items-center justify-center rounded-full border border-[#d8e2d2] bg-[#4f6f52] text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#405d43] dark:border-white/15 dark:bg-white/10 dark:text-[#f6f1e8] dark:hover:bg-white/15"
                        aria-label="GitHub"
                        title="GitHub"
                    >
                ...
                <p class="text-center text-sm font-semibold tracking-wide text-[#4b5563] transition-colors duration-300 dark:text-[#f6f1e8]/75 sm:text-right">
                    Copyright ©{{ date('Y') }} By
                    <span class="mx-1 text-[#4f6f52] dark:text-[#f6f1e8]">♥</span>
                    <span class="font-black text-[#111827] dark:text-white">ApikaCoding</span>
                </p>
            </div>
        </div>
    </div>
