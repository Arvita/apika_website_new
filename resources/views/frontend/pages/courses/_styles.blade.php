    ...
    @push('styles')
        <style>
            ...
            .submaterial-card {
                ...
                border-radius: 24px;
                border: 1px solid #e7ded1;
                background: linear-gradient(135deg, rgba(255, 255, 255, .96), rgba(251, 250, 247, .82));
                box-shadow: 0 10px 28px rgba(31, 41, 51, .045);
            }

            .dark .submaterial-card {
                border-color: rgba(255, 255, 255, .10);
                background: linear-gradient(135deg, rgba(255, 255, 255, .075), rgba(255, 255, 255, .035));
                box-shadow: none;
            }

            .submaterial-card-head {
                display: grid;
            ...
            .dark .submaterial-number {
                background: rgba(79, 111, 82, .22);
                color: #dbe8d4;
            }

            .submaterial-head-content {
                min-width: 0;
            }
            ...
            .dark .submaterial-body {
                color: rgba(215, 206, 192, .76);
            }

            .submaterial-code-box {
                max-width: 100%;
                margin-top: 20px;
                overflow: hidden;
                border-radius: 20px;
            ...
            .dark .submaterial-code-box {
                border-color: rgba(255, 255, 255, .10);
            }

            .submaterial-code-top {
                display: flex;
                align-items: center;
                justify-content: space-between;
                min-height: 40px;
            ...
            .dark .reader-demo-frame {
                border-color: rgba(255, 255, 255, .10);
                background: rgba(255, 255, 255, .04);
                box-shadow: none;
            }

            .reader-demo-frame iframe {
                width: 100%;
                height: 100%;
                border: 0;
                background: #fff;
            ...
            .dark .reader-file-card {
                border-color: rgba(255, 255, 255, .10);
                background: rgba(255, 255, 255, .05);
            }

            .reader-file-card strong {
                display: inline-flex;
                align-items: center;
                min-height: 28px;
                padding: 0 11px;
