        ...
        <header class="sticky top-0 z-50 border-b border-[#e3d8c8]/80 bg-[#f7f2ea]/85 backdrop-blur-xl dark:border-white/10 dark:bg-[#151b18]/85">
            <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
                <a href="{{ route('home') }}" class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-black leading-none tracking-tight">Arvita Agus K.</p>
                ...
                <nav class="hidden items-center gap-6 text-sm font-medium text-[#6b6258] dark:text-[#bdb4a7] lg:flex">
                    <a href="{{ route('courses.index') }}" class="transition hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Belajar</a>
                    <a href="{{ route('publications.index') }}" class="transition hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Jurnal</a>
                    <a href="{{ route('videos.index') }}" class="transition hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Video</a>
                    <a href="{{ route('research') }}" class="transition hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Riset</a>
                    <a href="{{ route('supervisions.index') }}" class="transition hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Bimbinganku</a>
                    <a href="{{ route('portfolio.index') }}" class="transition hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Portfolio</a>
                </nav>

                <div class="flex items-center gap-2">
                    <button type="button" class="rounded-full border border-[#e3d8c8] bg-[#fffaf2] px-3 py-2 text-xs font-black text-[#4f6f52] dark:border-white/10 dark:bg-[#1f2722] dark:text-[#c7d7a9]">
                        ID
                    </button>

                    <button type="button" onclick="toggleTheme()" class="rounded-full border border-[#e3d8c8] bg-[#fffaf2] px-3 py-2 text-xs font-black text-[#4f6f52] dark:border-white/10 dark:bg-[#1f2722] dark:text-[#c7d7a9]">
                        Mode
                    </button>

                    <a href="{{ route('contact') }}" class="hidden rounded-full bg-[#4f6f52] px-4 py-2 text-sm font-bold text-white dark:bg-[#9caf88] dark:text-[#151b18] sm:inline-flex">
                        Kontak
                    </a>
                </div>
            </div>
        ...
        <footer class="border-t border-[#e3d8c8] bg-[#fffaf2]/70 dark:border-white/10 dark:bg-[#1f2722]/70">
            <div class="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
                ...
                <div>
                    ...
                    <div class="mt-4 space-y-2 text-sm text-[#6b6258] dark:text-[#bdb4a7]">
                        <a href="{{ route('courses.index') }}" class="block hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Belajar</a>
                        <a href="{{ route('publications.index') }}" class="block hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Jurnal</a>
                        <a href="{{ route('videos.index') }}" class="block hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Video</a>
                        <a href="{{ route('supervisions.index') }}" class="block hover:text-[#4f6f52] dark:hover:text-[#c7d7a9]">Bimbinganku</a>
                    </div>
                </div>
            </div>
